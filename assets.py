...
class Sounds:
    def __init__(self) -> None:
        ...
        self.bubble_warfare_background = pygame.mixer.Sound(
            "assets/sounds/hometheme.wav"
        )
...
class Images:
    def __init__(self) -> None:
        ...
        self.game_selection_background = pygame.transform.scale(
            pygame.image.load("assets/images/gameselection_space_2.jpeg"),
            (consts.SCREEN_WIDTH / 2, consts.SCREEN_HEIGHT / 2),
        )
        ...
        self.left_arrow = pygame.transform.scale(
            pygame.image.load("assets/images/selectionarrow_left.png"),
            (consts.SCREEN_WIDTH / 2, consts.SCREEN_HEIGHT / 2),
        )
        self.right_arrow = pygame.transform.scale(
            pygame.image.load("assets/images/selectionarrow_right.png"),
            (consts.SCREEN_WIDTH / 2, consts.SCREEN_HEIGHT / 2),
        )
