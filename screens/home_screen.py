...
import consts
class HomeScreen:
    def __init__(self, py_screen, width, height):
        self.width = width
        self.height = height    
        self.background = pygame.transform.scale(pygame.image.load("assets/images/bubble_warfare.png"), (self.width, self.height))
        self.py_screen = py_screen
        self.next_screen = consts.HOME_SCREEN
    
    def start_game_button(self, text, x, y, width, height, color):
    ...
    def draw(self, dt):
        ...
        if self.start_game_button("Start Game", button_x, button_y, button_width, button_height, (50, 200, 50)):
